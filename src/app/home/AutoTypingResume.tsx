      ...
      <ResumeIframeCSR documentSize="Letter" scale={isLg ? 0.7 : 0.5}>
        <ResumePDF
          ...
          settings={{
            ...
            fontSize: "12",
            formToHeading: {
              // Guard against empty arrays while the auto-typing iterator
              // transitions the resume object (END_HOME_RESUME may contain
              // zero work experiences). Use optional chaining to avoid
