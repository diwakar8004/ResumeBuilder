...
export const Testimonials = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <section className="mx-auto -mt-2 px-4 sm:px-8 pb-24 py-16">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">Join thousands who've landed their dream jobs with ResumeBuilder</p>
      </div>
        ...
        <div className="relative lg:ml-[-50px]">
          {TESTIMONIALS.map(({ src, quote, name, title }, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`bg-primary absolute max-w-lg rounded-[1.7rem] bg-opacity-30 shadow-md dark:shadow-lg dark:shadow-gray-950 transition-all duration-1000 ease-linear ${className}`}
                onMouseEnter={() => {
                  if (className === "z-10") {
              ...
              >
                <figure className="m-1 flex gap-5 rounded-3xl bg-white dark:bg-gray-800 p-5 text-gray-900 dark:text-gray-100 lg:p-7 transition-colors duration-300">
                  <Image
