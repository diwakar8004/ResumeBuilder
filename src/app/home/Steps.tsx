...
export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-2xl bg-sky-50 dark:bg-gray-800 bg-dot dark:bg-dot-dark px-4 sm:px-8 pb-12 pt-10 lg:mt-2 transition-colors duration-300">
      <h1 className="text-center text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">3 Simple Steps</h1>
