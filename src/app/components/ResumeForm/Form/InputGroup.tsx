...
export const InputGroupWrapper = ({
  ...
  <label className={`text-base font-medium text-gray-700 dark:text-gray-300 transition-colors duration-200 ${className}`}>
    {label}
    {children}
  </label>
);
...
export const INPUT_CLASS_NAME =
  "mt-1 px-3 py-2 block w-full rounded-md border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 shadow-sm outline-none font-normal text-base transition-all duration-200 hover:border-blue-400 dark:hover:border-blue-500 hover:shadow-md focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 placeholder:text-gray-500 dark:placeholder:text-gray-400";
