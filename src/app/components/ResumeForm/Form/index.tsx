...
export const BaseForm = ({
  ...
  <section
    className={`flex flex-col gap-3 rounded-md bg-white dark:bg-gray-800 p-6 pt-4 shadow dark:shadow-lg dark:shadow-gray-950 transition-all duration-300 ${className}`}
  >
    {children}
  </section>
);
    ...
    >
      <div className="flex items-center justify-between gap-4">
        <div className="flex grow items-center gap-2">
          ...
          <input
            type="text"
            className="block w-full border-b border-transparent text-lg font-semibold tracking-wide text-gray-900 dark:text-gray-100 outline-none hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-sm focus:border-gray-300 dark:focus:border-gray-600 focus:shadow-sm dark:bg-gray-800"
            value={heading}
      ...
      {showForm && addButtonText && (
        <div className="mt-2 flex justify-end">
          <button
            ...
            className="flex items-center rounded-md bg-white dark:bg-gray-700 py-2 pl-3 pr-4 text-sm font-semibold text-gray-900 dark:text-gray-100 shadow-sm dark:shadow-md ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
            <PlusSmallIcon
              className="-ml-0.5 mr-1.5 h-5 w-5 text-gray-400 dark:text-gray-500"
              aria-hidden="true"
            />
            {addButtonText}
          </button>
